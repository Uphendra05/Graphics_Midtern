...
//void PhysicsEngine::AddSoftBodyObject(SoftBody* objs)
//{
//   
...
//void PhysicsEngine::RemoveSoftBodyObject(SoftBody* objs)
//{
//    std::vector<SoftBody*>::iterator it = std::find(softBodyObjects.begin(), softBodyObjects.end(), objs);
...
void PhysicsEngine::AddSoftBodyObject(SoftBodyObjs* objs)
{
    softbodyObjects.push_back(objs);
}

void PhysicsEngine::RemoveSoftBodyObject(SoftBodyObjs* objs)
{
